...
| EXP-034 | Visual frequency-overlay and ROI-mask audit | Audit actual-pixel overlays, ROI mask status, patch leakage, domain fingerprints, and split contamination. | completed-forensic | protocol: `docs/VISUAL_LEAKAGE_AUDIT_PROTOCOL.md`; output: `experiments/visual_domain_leakage_audit_v002_retry01/` | leakage-risk evidence |
