...
- Output directory: `outputs\encoder_features_normalized_v001`
- Device: `cuda`
- Batch size: `64`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| random | grayscale 1-channel input, resized to 256x256, normalized with mean=0.5/std=0.5; conv1 adapted to 1 input channel | 12944 | 512 | 0 | 0 | 0 | True | True | True | `outputs\encoder_features_normalized_v001\features_resnet18_random.normalized.npz` |
| imagenet | grayscale ESPI image repeated to RGB, resized to 256x256, ImageNet mean/std normalization | 12944 | 512 | 0 | 0 | 0 | True | True | True | `outputs\encoder_features_normalized_v001\features_resnet18_imagenet.normalized.npz` |
