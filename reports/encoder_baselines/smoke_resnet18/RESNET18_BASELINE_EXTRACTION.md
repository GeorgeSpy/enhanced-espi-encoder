...
- Output directory: `outputs\encoder_features_normalized_v001\smoke_resnet18`
- Device: `cpu`
- Batch size: `4`
- Full extraction: `False`
- Max samples when not full: `8`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| random | grayscale 1-channel input, resized to 256x256, normalized with mean=0.5/std=0.5; conv1 adapted to 1 input channel | 8 | 512 | 0 | 0 | 0 | True | True | True | `outputs\encoder_features_normalized_v001\smoke_resnet18\features_resnet18_random.normalized.npz` |
| imagenet | grayscale ESPI image repeated to RGB, resized to 256x256, ImageNet mean/std normalization | 8 | 512 | 0 | 0 | 0 | True | True | True | `outputs\encoder_features_normalized_v001\smoke_resnet18\features_resnet18_imagenet.normalized.npz` |
