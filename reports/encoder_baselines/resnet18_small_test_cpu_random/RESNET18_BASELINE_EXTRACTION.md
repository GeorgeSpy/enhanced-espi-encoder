...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| random | grayscale 1-channel input, resized to 256x256, normalized with mean=0.5/std=0.5; conv1 adapted to 1 input channel | 200 | 512 | 0 | 0 | 0 | True | True | True | `outputs\encoder_features_normalized_v001\resnet18_small_test_cpu\features_resnet18_random.normalized.npz` |
